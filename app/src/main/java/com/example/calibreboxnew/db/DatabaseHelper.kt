...
// CORRECT IMPORT: The generated class is 'Books'
...
object DatabaseHelper {
    ...
    fun getBooks(): List<Books> {
        val books = database?.bookQueries?.selectAll()?.executeAsList() ?: emptyList()
        Log.d("DatabaseHelper", "getBooks() found ${books.size} books.")
        return books
    }
}
